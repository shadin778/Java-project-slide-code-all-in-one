...
public class Start
{
	public static void main(String args[])
	{
		...
		Customer c1 = new Customer("01XXXXXXX",5);
		
		Account a1 = new Account(1111,"Abdul Karim",5000);
		Account a2 = new Account(1112,"Abdul Karim",5000);
		Account a3 = new Account(1113,"Abdul Rahim",5000);
		...
		c1.showAllAccounts();
		c1.removeAccountByAccountNumber(1113);
		c1.showAllAccounts();
		
		c1.searchAccountByAccHolderName("Abdul");
		
		/*
		c1.showAllAccounts();
		c1.removeAccountByAccountNumber(1112);
		...
		c1.searchAccountByAccNo(11111114);
		c1.searchAccountByAccHolderName("OOP2 G");
	*/
