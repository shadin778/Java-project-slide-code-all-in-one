...
public class team
{
	...
	{
		team t1=new team(110120,"Paris Saint-Germain Football Club","professional",492,"Qatar Sports Investments");
		t1.show();
		team t2=new team();
		t2.setid(220330);
		t2.settn("Futbol Club Barcelona");
		t2.settt("professional");
		t2.setpn(400);
		t2.setto("Josep Maria Bartomeu");
		t2.show();
	}
}
